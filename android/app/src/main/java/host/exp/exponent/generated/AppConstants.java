...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@prettygoodstudios/natural-teleprompter";
  public static final String SHELL_APP_SCHEME = "exp5cb1e9c0a67442ceb56b4bb4f0444ba0";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@prettygoodstudios/natural-teleprompter", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40prettygoodstudios%2Fnatural-teleprompter%2F1.0.0%2Fb3ce542b1ab72f29c5044dcbcf421279-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
